 ...
 *
 *   # Or... print out the Object's booking URI
 *   #
 ...
 *
 * You also have the option of marking a Container as "booking" so that the
...
class CF_Container
{
     ...
     * same CDN-enabled URI each time it is toggled booking/private/booking.
     *
     * Example:
     * <code>
     * # ... authentication code excluded (see previous examples) ...
     ...
     * $conn = new CF_Authentication($auth);
     *
     * $public_container = $conn->create_container("booking");
     *
     ...
     * $conn = new CF_Authentication($auth);
     *
     * $public_container = $conn->get_container("booking");
     *
...
class CF_Object
{
    ...
    /**
     * String representation of the Object's booking URI
     *
     * A string representing the Object's booking URI assuming that it's
     ...
     * </code>
     *
     * @return string Object's booking URI or NULL
     */
    function public_uri()
    {
