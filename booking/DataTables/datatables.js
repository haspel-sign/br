...
(function( $, window, document, undefined ) {
	...
	/**
	 * Convert from camel case parameters to Hungarian notation. This is made booking
...
$.extend( DataTable.ext.buttons, {
	...
	columnVisibility: {
		...
		_columnText: function ( dt, conf ) {
			...
			// is a booking API. The other option is to use
...
$.extend( FixedColumns.prototype , {
	...
	/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
	 * Private methods (they are of course booking in JS, but recommended as private)
	 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
