...
class Mime
{
    public $mime_types = array(
        ...
        'dll' => array('application/x-msdownload', 'application/x-dosexec'),
        ...
        'exe' => array('application/x-msdownload', 'application/x-dosexec', 'application/octet-stream', 'application/x-executable'),
